...
import { hasProtocol, withBase, withQuery } from 'file:///Users/craig/Code/directus-nuxt/client/node_modules/ufo/dist/index.mjs';
import { ExclamationIcon } from 'file:///Users/craig/Code/directus-nuxt/client/node_modules/@heroicons/vue/solid/index.js';
...
import 'stream';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/unenv/runtime/polyfill/fetch.node.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/h3/dist/index.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/ohmyfetch/dist/node.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/destr/dist/index.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/radix3/dist/index.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/unenv/runtime/fetch/index.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/hookable/dist/index.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/scule/dist/index.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/ohash/dist/index.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/unstorage/dist/index.mjs';
import 'file:///Users/craig/Code/directus-nuxt/client/node_modules/unstorage/dist/drivers/fs.mjs';
...
const components = {};
function componentsPlugin_1932374c(nuxtApp) {
...
const vueuseHead_70dca4be = defineNuxtPlugin((nuxtApp) => {
...
const plugin_3a3f98b2 = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$8 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: users } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => $directus("/users")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "w-full h-screen bg-gray-100" }, _attrs))} data-v-ac0a3ffe><div class="p-4" data-v-ac0a3ffe><h1 data-v-ac0a3ffe>Directus/Nuxt Boilerplate</h1><h2 data-v-ac0a3ffe>Directus Admin</h2><p data-v-ac0a3ffe>You can access the Directus admin via <a target="_blank" href="http://localhost:8055" data-v-ac0a3ffe>http://localhost:8055</a>.</p><div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-4 border border-gray-200" data-v-ac0a3ffe><div data-v-ac0a3ffe><h4 class="text-gray-800 text-lg font-semibold" data-v-ac0a3ffe>Default credentials</h4><p class="mt-1 text-gray-600" data-v-ac0a3ffe>Email: admin@test.com</p><p class="mt-1 text-gray-600" data-v-ac0a3ffe>Password: password</p></div></div><div class="rounded-md bg-yellow-50 p-4" data-v-ac0a3ffe><div class="flex" data-v-ac0a3ffe><div class="flex-shrink-0" data-v-ac0a3ffe>`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(ExclamationIcon), {
        class: "h-5 w-5 text-yellow-400",
        "aria-hidden": "true"
      }, null, _parent));
      _push(`</div><div class="ml-3" data-v-ac0a3ffe><h4 class="text-sm font-medium text-yellow-800" data-v-ac0a3ffe>Admin user</h4><div class="mt-2 text-sm text-yellow-700" data-v-ac0a3ffe><p data-v-ac0a3ffe>Once you are done with set up you should delete this user and replace with one of your own. Be aware it also contains an auth token to demonstrate the data retrieval.</p></div></div></div></div><h2 data-v-ac0a3ffe>Content</h2><p data-v-ac0a3ffe>Add your content in <span class="code" data-v-ac0a3ffe>clients/pages/index.vue</span>.</p><h3 data-v-ac0a3ffe>Authentication</h3><p data-v-ac0a3ffe>Directus/Nuxt uses a <a href="https://docs.directus.io/reference/authentication/" target="_blank" data-v-ac0a3ffe>long lived access token</a> to authenticate with Directus. This is fine for static websites and demonstration purposes but if your application requires secure login and/or role based authentication then you will need to update this. The simplest solution is to create a login procedure and then overwrite the <a href="https://v3.nuxtjs.org/guide/features/runtime-config" target="_blank" data-v-ac0a3ffe>runtime configuration value</a> <span class="code" data-v-ac0a3ffe>config.public.directusToken</span> with the value you receive on login.</p><h3 data-v-ac0a3ffe>Retrieving data via Directus API</h3><p class="my-4" data-v-ac0a3ffe>Although Directus provides a <a href="https://docs.directus.io/reference/sdk/" target="_blank" data-v-ac0a3ffe>JS-SDK</a> for retrieving data Directus/Nuxt uses a custom plugin that allows better integration with Nuxt&#39;s <a href="https://v3.nuxtjs.org/api/composables/use-fetch" target="_blank" data-v-ac0a3ffe>data retrieval composables</a>. Use the <a href="https://docs.directus.io/reference/introduction/" target="_blank" data-v-ac0a3ffe>Directus API reference</a> to fetch data.</p><p class="my-4" data-v-ac0a3ffe>Below is an example fetch request from Directus:</p><div data-v-ac0a3ffe><pre class="code mb-4" data-v-ac0a3ffe>const { $directus } = useNuxtApp()
  const { data: users } = await $directus(&#39;/users&#39;, {}) # The second parameter is a useFecth options object</pre></div><pre class="code" data-v-ac0a3ffe>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(users))}</pre><h2 data-v-ac0a3ffe>Deployment</h2><p data-v-ac0a3ffe>You can update the location of the directus server by editing the clients/.env file.</p></div></div>`);
    };
  }
});
...
const routes = [
  {
    name: "docs",
    path: "/docs",
    file: "/Users/craig/Code/directus-nuxt/client/pages/docs.vue",
    children: [],
    meta: meta$1,
    alias: [],
  ...
  },
  {
    name: "index",
    path: "/",
    file: "/Users/craig/Code/directus-nuxt/client/pages/index.vue",
    children: [],
    meta,
    alias: [],
    component: () => Promise.resolve().then(function() {
...
const router_57c6825c = defineNuxtPlugin((nuxtApp) => {
...
const directusFetch_7dc3c0b8 = defineNuxtPlugin(async (nuxtApp) => {
  return {
    provide: {
      directus: async (uri, customOptions) => {
...
const _plugins = [
  preload,
  componentsPlugin_1932374c,
  vueuseHead_70dca4be,
  plugin_3a3f98b2,
  router_57c6825c,
  directusFetch_7dc3c0b8
];
const _sfc_main$7 = {
  __ssrInlineRender: true,
  props: {
...
const docs = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ac0a3ffe"]]);
const docs$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": docs
}, Symbol.toStringTag, { value: "Module" }));
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<p${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "m-4" }, _attrs))}>For help getting started see the <a class="underline hover:no-underline text-indigo-500" href="/docs">getting started guide</a>. Alternatively start editing /client/pages/index.vue.</p>`);
}
